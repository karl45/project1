...
namespace aspnetfirst.Migrations
{
    ...
    [Migration("20191129072358_withoutlist")]
    partial class withoutlist
    {
            ...
            modelBuilder.Entity("aspnetfirst.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1", AccessFailedCount = 0, ConcurrencyStamp = "91b2bd4d-9363-483c-8961-c6947d2aa1bd", EmailConfirmed = false, LockoutEnabled = false, PhoneNumberConfirmed = false, Points = 100, TwoFactorEnabled = false, UserName = "Ali", UserPassword = "AliPass" },
                        new { Id = "2", AccessFailedCount = 0, ConcurrencyStamp = "1d280c75-df8e-4875-a336-d8fc66a11af1", EmailConfirmed = false, LockoutEnabled = false, PhoneNumberConfirmed = false, Points = 80, TwoFactorEnabled = false, UserName = "Dias", UserPassword = "seniorhacka" }
                    );
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "5e5418db-a7eb-45ec-9f70-08b9a0c99cf0", ConcurrencyStamp = "6dc27a4e-40e4-4ec6-95de-aade2c58f203", Name = "admin" },
                        new { Id = "ea5a6f35-b2e8-4b5a-a5d0-b1db406944a8", ConcurrencyStamp = "364bf46b-eef0-4abd-a043-ce5d660a519c", Name = "user" }
                    );
                });
