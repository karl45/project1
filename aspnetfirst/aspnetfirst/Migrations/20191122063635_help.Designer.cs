            ...
            modelBuilder.Entity("aspnetfirst.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1", AccessFailedCount = 0, ConcurrencyStamp = "dbfdaf5f-1fd0-4e3c-a036-63d30b48f21b", EmailConfirmed = false, LockoutEnabled = false, PhoneNumberConfirmed = false, Points = 100, TwoFactorEnabled = false, UserName = "Ali", UserPassword = "AliPass" },
                        new { Id = "2", AccessFailedCount = 0, ConcurrencyStamp = "8fa66b83-615b-4732-aa09-a28df72f3379", EmailConfirmed = false, LockoutEnabled = false, PhoneNumberConfirmed = false, Points = 80, TwoFactorEnabled = false, UserName = "Dias", UserPassword = "seniorhacka" }
                    );
                });
