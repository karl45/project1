...
namespace aspnetfirst.Migrations
{
    ...
    [Migration("20191122090429_roles")]
    partial class roles
    {
            ...
            modelBuilder.Entity("aspnetfirst.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1", AccessFailedCount = 0, ConcurrencyStamp = "d715c96e-97b8-48ca-9066-4fac7a1c887b", EmailConfirmed = false, LockoutEnabled = false, PhoneNumberConfirmed = false, Points = 100, TwoFactorEnabled = false, UserName = "Ali", UserPassword = "AliPass" },
                        new { Id = "2", AccessFailedCount = 0, ConcurrencyStamp = "f85a1d70-d09c-4116-96e1-be44bdc2bb2a", EmailConfirmed = false, LockoutEnabled = false, PhoneNumberConfirmed = false, Points = 80, TwoFactorEnabled = false, UserName = "Dias", UserPassword = "seniorhacka" }
                    );
                });
