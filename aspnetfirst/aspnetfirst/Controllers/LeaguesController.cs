...
namespace aspnetfirst.Controllers
{
    public class LeaguesController : Controller
    {
        ...
        public LeaguesController(BetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LeagueId,LeaugueName")] League league)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeagueId,LeaugueName")] League league)
        {
