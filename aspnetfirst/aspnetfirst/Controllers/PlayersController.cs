...
namespace aspnetfirst.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(BetContext context)
        {
            _context = context;
        }
        ...
        {
            var betContext = _context.Player.Include(p => p.Team);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerId,PlayerName,Offence,Deffence,TeamId")] Player player)
        {
